...
if(isset($_GET['install']))
{
    ...
    mysql_query("CREATE TABLE IF NOT EXISTS `pay` (  `username` char(15) DEFAULT NULL,  `pubKey` varchar(500) DEFAULT NULL,  `priKey` varchar(1000) DEFAULT NULL,  `appId` varchar(17) DEFAULT NULL) ENGINE=MyISAM DEFAULT CHARSET=utf8");
}
